<?php
/**
 * Template part for displaying project content in the Large layout.
 *
		...
		<div class="content-inner">
			...
			<div class="entry-summary">
				...
				if ( has_post_thumbnail() ) {
					evie_portfolio_project_attributes( get_the_ID(), 2, 1 );
				} else {
					the_excerpt();
					evie_portfolio_project_attributes( get_the_ID(), 4, 1 );
				}
				?>
