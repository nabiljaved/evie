...
;// CONCATENATED MODULE: ./src/modules/theme-options/js/inc/post-setting-panel.js
...
function PostSettingPanel(_ref) {
  let {
    meta,
    setMeta
  } = _ref;
  ...
  return (0,react.createElement)(PluginDocumentSettingPanel, {
    name: "evie-post-setting-panel",
    title: __('Layout', 'evie-xt'),
    className: "evie-post-setting-panel"
  }, (0,react.createElement)(BaseControl, null, (0,react.createElement)(ButtonGroup, {
    className: "layout-options"
  }, layoutOptions.map(value => (0,react.createElement)(Button, {
    key: `layout-option-${value}`,
    isPressed: value === getSetting('_evie_layout'),
    onClick: () => {
      onChange('_evie_layout', value);
    }
  }, (0,react.createElement)(Icon, {
    icon: icons[`layout${value}`]
  }))))));
}
/* harmony default export */ var post_setting_panel = (compose([withSelect(select => {
  return {
...
;// CONCATENATED MODULE: ./src/modules/theme-options/js/post.js
/**
 * Internal dependencies
 */
...
registerPlugin('evie-post-setting-panel', {
  render: post_setting_panel,
