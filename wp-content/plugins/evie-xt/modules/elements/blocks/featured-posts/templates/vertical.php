...
<div <?php echo get_block_wrapper_attributes( $evie_attrs ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
			...
			<div class="<?php echo esc_attr( implode( ' ', $evie_post_classes ) ); ?>">
				...
				<header class="slide-header">
					...
					if ( true === $attributes['displayCategory'] ) {
						evie_post_meta_categories( $evie_featured_post, 'category', '/' );
					}
				...
				<div class="slide-text">
					...
					<p class="slide-summary">
						<?php echo get_the_excerpt( $evie_featured_post ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
					</p>					
	...
	<div class="slider-background"><span class="slider-background-text flext-animation-reveal"></span></div>
